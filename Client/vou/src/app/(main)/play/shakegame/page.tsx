...
import PlayIcon from "@/components/icons/IconMusic";
const Page = ({
	searchParams,
}: {
	searchParams: {
	...
	return (
		<div
			className="bg-gray-100 flex items-center justify-center h-screen w-full overflow-y-hidden max-h-[calc(100vh-80px)]"
			style={{
				margin: "0 auto",
				position: "relative",
		...
		>
			...
			<button
				...
				style={{
					boxShadow:
						"inset -4px -4px 10px rgba(255, 255, 255, 0.3), inset 4px 4px 10px rgba(0, 0, 0, 0.7)",
				}}
			>
